module Solucion (usuarios, nombresDeUsuarios, relaciones, publicaciones, idDeUsuario, usuarioDePublicacion, likesDePublicacion, Usuario, Relacion, Publicacion, RedSocial, nombreDeUsuario, amigosDe, cantidadDeAmigos, usuarioConMasAmigos, estaRobertoCarlos, publicacionesDe, publicacionesQueLeGustanA, lesGustanLasMismasPublicaciones, tieneUnSeguidorFiel, existeSecuenciaDeAmigos) where 
